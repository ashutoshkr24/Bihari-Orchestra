...
let playlist = [
  {
    title: "लालीपाप लागेलू (Lollipop Lagelu)",
    artist: "पवन सिंह • स्टेज ऑर्केस्ट्रा स्पेशल",
    src: "/songs/01_Pawan_Singh_-_Lollipop_Lagelu.wav",
    cover: "img/hero-bg.jpg"
  },
  {
    title: "बिदेसिया लोकगीत (Bidesiya Lokgeet)",
    artist: "भिखारी ठाकुर परंपरा • लोकनाट्य",
    src: "/songs/02_Bhikhari_Thakur_-_Bidesiya_Lokgeet.wav",
    cover: "img/hero-bg.jpg"
  },
  {
    title: "रिंकिया के पापा (Rinkiya Ke Papa)",
    artist: "मनोज तिवारी • देसी ऑर्केस्ट्रा",
    src: "/songs/03_Manoj_Tiwari_-_Rinkiya_Ke_Papa.wav",
    cover: "img/hero-bg.jpg"
  },
  {
    title: "पिया के गाँव (Piya Ke Gaon)",
    artist: "शारदा सिन्हा • पारम्परिक लोकगीत",
    src: "/songs/04_Sharda_Sinha_-_Piya_Ke_Gaon.wav",
    cover: "img/hero-bg.jpg"
  }
];
...
async function fetchLocalSongs() {
  try {
    ...
    console.log('Using default local songs playlist');
  }
